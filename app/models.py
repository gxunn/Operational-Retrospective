...
class VideoBreakdown(Base):
    ...
    likes: Mapped[float] = mapped_column(Float, default=0)
    comments: Mapped[float] = mapped_column(Float, default=0)
    collect_count: Mapped[float] = mapped_column(Float, default=0)
    share_count: Mapped[float] = mapped_column(Float, default=0)
    script_content: Mapped[str] = mapped_column(Text, default="")
    video_text: Mapped[str] = mapped_column(Text, default="")
    transcript: Mapped[str] = mapped_column(Text, default="")
    fetch_status: Mapped[str] = mapped_column(String(20), default="未抓取")
    fetch_error: Mapped[str] = mapped_column(Text, default="")
    analysis_json: Mapped[str] = mapped_column(Text, default="{}")
    analysis_markdown: Mapped[str] = mapped_column(Text, default="")
    analysis_status: Mapped[str] = mapped_column(String(20), default="未开始")
